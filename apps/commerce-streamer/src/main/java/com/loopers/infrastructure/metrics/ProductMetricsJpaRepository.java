...
public interface ProductMetricsJpaRepository extends JpaRepository<ProductMetrics, Long> {
    ...
    @Modifying
    @Query(value = "INSERT INTO product_metrics (product_id, view_count, like_count, sales_count, latest_price, price_updated_at) " +
        "VALUES (:productId, 0, 0, 0, :price, :occurredAt) " +
        ...
        nativeQuery = true)
    void upsertPrice(@Param("productId") Long productId, @Param("price") BigDecimal price,
